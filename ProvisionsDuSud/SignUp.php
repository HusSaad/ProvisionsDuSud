...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
        ...
        $sql = "SELECT id FROM tb_users WHERE email = ?";
    ...
    if(empty($last_name_err) && empty($first_name_err) &&empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        
        // Prepare an insert statement
        $sql = "INSERT INTO tb_users (first_name,last_name,email, password) VALUES (?, ?, ?, ?)";
